...
<html>
					...
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form action="${pageContext.request.contextPath }/cart" id="form1" method="get">
								...
								<a href="javascript:void(0)" onclick="subForm()" id="cart">
									<input style="background: url('${pageContext.request.contextPath}/images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:100px;" value="加入购物车" type="button">
								</a> 
								<a href="javascript:void(0);"onclick="removeFromCart('${bean.pid}')" id="collection">
								<%-- <a href="${pageContext.request.contextPath }/collection?method=addByPid&pid=${bean.pid}" id="collection"> --%>
								 <h4>加入收藏</color></h4> 
								</a>
								</div>
						</div>
	...
	<script type="text/javascript">
		...
		function removeFromCart(pid){
			if(confirm("确定收藏本图书吗?")){
				location.href="${pageContext.request.contextPath}/collection?method=addByPid&pid="+pid;
			}
		}
	</script>
</html>