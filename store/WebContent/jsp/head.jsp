				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
						...
						<li><a href="${pageContext.request.contextPath }/jsp/cart.jsp">购物车</a></li>
							...
							<li><a href="${pageContext.request.contextPath }/collection?method=findMyCOllectionByPage&pageNumber=1">收藏夹</a></li>
							<li><a href="${pageContext.request.contextPath }/jsp/info.jsp">个人信息</a></li>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<input type="hidden" name="method" value="findByBname">
								<div class="form-group">
									<input type="text" class="form-control" placeholder="按书名查询" name="Bname">
								</div>
