...
<html>
 ...
 <c:if test="${empty pb || empty pb.data }">
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			<div class="col-md-12">
				<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath }/product?method=findByBname&pageNumber=1&Bname=${param.Bname}">第一页</a></li>
					<li><a href="${pageContext.request.contextPath }/product?method=findByBname&pageNumber=${pb.totalPage}&Bname=${param.Bname}">最后一页</a></li>
				</ol>
			</div>
			<c:forEach items="${pb.data }" var="p">
				<div class="col-md-2">
					...
					<p><a href="${pageContext.request.contextPath }/product?method=getById" style='color:green'>${fn:substring(p.pname,0,10) }..</a></p>
