...
<div class="container"  style="width:100%;height:460px;background:#ffffff url('${pageContext.request.contextPath}/images/loginbg.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
	...
	<div class="col-md-5">
				<div style="position:relative;right:65%;width:440px;border:1px solid #E7E7E7;padding:20px 0 20px 30px;border-radius:5px;margin-top:60px;background:#ffffff;">
				<font>用户登录</font> ${msg }
...
<form class="form-horizontal" action="${pageContext.request.contextPath }/user" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
   <input type="text" class="form-control" id="inputPassword3" placeholder="请输入验证码" name="checkcode" size="4">
    </div>
    <div class="col-sm-3">
